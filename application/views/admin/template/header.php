...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/css/owlcarousel.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/css/prism.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/css/whether-icon.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->

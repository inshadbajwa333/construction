...
class Users extends MY_Controller {
     ...
     public function index()
    {
        ...
        $data['users']=$this->m->getAll('login_reg',null,null,null,null,'users_id','DESC');
        $data['page']='users/viewUsers';
    ...
    public function createUser(){
        ...
        if (!$this->upload->do_upload('u_image')) 
		{
            ...
            $data['u_image'] = $this->upload->data('file_name');
        }
        ...
        $data = array(
            ...
            'users_bio' => $this->input->post('bio'),
            'users_img' => $data['u_image'],
            'status' => 1
        );

        $insert=$this->m->store('login_reg',$data);
